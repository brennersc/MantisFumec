...
// echo '$f_new_status ' . $f_new_status;
// echo "<br>";
// echo '$f_change_type ' . $f_change_type;
// echo "<br>";
// echo '$t_reopen ' . $t_reopen;
// echo "<br>";
// echo '$t_resolved ' . $t_resolved;
// echo "<br>";
// echo '$t_closed ' . $t_closed;
// echo "<br>";
// echo '$t_resolution_fixed ' . $t_resolution_fixed ;
// echo "<br>";
// echo ' $t_current_user_id ' . $t_current_user_id;
