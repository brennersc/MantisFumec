...
// $g_status_colors = array(
// 	'new'          => '#fcbdbd', // red    (scarlet red #ef2929)
// 	'feedback'     => '#e3b7eb', //e3b7eb purple (plum        #75507b)
// 	'acknowledged' => '#ffcd85', // orange (orango      #f57900)
// 	'confirmed'    => '#fff494', // yellow (butter      #fce94f)
// 	'assigned'     => '#d2f5b0', // blue   (sky blue    #729fcf)
// 	'test'         => '#c2dfff', // Madeira
// 	'tested'       => '#D7A45A', // Limao
// 	'resolved'     => '#8ae234', // d2f5b0 green  (chameleon   #8ae234)
// 	'closed'       => '#c9ccc4'  // grey  (aluminum    #babdb6)
// ); 
...
'acknowledged'			=> '#ffcd85',
'replanning'			=> '#d2f5b0',
'under development'		=> '#fff494',
'paralyzed'				=> '#D7A45A',
'released for testing'	=> '#bfef8f',
'in test'				=> '#c2dfff',
'feedback'				=> '#e3b7eb',
'homologated'			=> '#A4A4A4',
'in validation'			=> '#0080FF',
'validated'				=> '#00FFFF',
'completed'				=> '#8ae234',
'rejected'				=> '#ff471a'  
);
...
//$g_status_enum_string = '10:new,20:feedback,30:acknowledged,40:confirmed,50:assigned,60:test,70:tested,80:resolved,90:closed';


$g_status_enum_string = '10:new,20:in analysis,30:acknowledged,40:replanning,50:under development,60:paralyzed,70:released for testing,
80:in test,93:feedback,100:homologated,110:in validation,120:validated,130:completed,140:rejected';
...
$g_resolution_enum_string = '10:open,20:fixed,30:reopened,40:unable to duplicate,50:not fixable,60:duplicate,70:not a bug,80:suspended,90:wont fix,100:tested in,110:test over';
...
if (
	isset($_SERVER['SERVER_NAME']) && (strcasecmp($_SERVER['SERVER_NAME'], 'localhost') == 0 ||
